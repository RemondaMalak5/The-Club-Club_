...
//       const body = {
//         invoice_id: selectedPaymentItem.id,
...
//                     {/* دفع الأكاديميات لسه مش مربوط */}

//                     {item.payable && (

//                       <button
//                         type="button"
//                         className="w-full mt-5 bg-gray-300 text-gray-600 py-3 rounded-xl font-semibold cursor-not-allowed"
//                         disabled
//                       >
//                         ادفع الآن
//                       </button>
