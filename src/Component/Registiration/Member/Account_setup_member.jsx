...
export const Account_setup_member = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <Stepper_green title="اعدادات الحساب " currentStep={4} />
      <div className="border p-7 w-[50%] flex flex-col gap-3  rounded-xl shadow-2xl">
        ...
        <div>
          {arr.map((item, index) => (
            <div key={index} className="flex flex-col gap-2 mt-4">
              <label className="font-medium text-[16px] text-[#364153] flex gap-1"> {item.label} <span className="text-[#00786F] text-[18px]"> *</span> </label>
              <input
                type="text"
        ...
        <button
          onClick={() => navigate("/")}
          className="bg-gradient-to-r from-[#08AC85DB] to-[#00786F] text-white p-3 rounded-lg w-full mt-5 flex justify-center items-center gap-1"
        >
          التالى
