...
const Account_setup = () => {
  ...
  const validateField = (name, value) => {
    switch (name) {
      ...
      case "confirm_password":
        ...
        if (value !== formData.password) return t("confirm_password_mismatch");
        return "";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setErrors({
        general:
          error?.response?.data?.message?.error || t("create_account_error"),
      });
    } finally {
      setLoading(false);
    }
              ...
              <div className="relative">
                ...
                {item.name === "password" && (
                  <span
                    ...
                    } top-1/2 -translate-y-1/2 text-[#FF683B] cursor-pointer`}
                  >
